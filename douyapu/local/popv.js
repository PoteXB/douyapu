            ...
            if (type == "active") {
                ...
                if (data && data.results && data.results.length > 0) {
                    ...
                    $.each(data.results, function (key, value) {
                        ...
                        oli += `<li class="clear">
                        <div class="fl">
                            <a href="${popUrl.website}coupon/transfer?item=${value.itemId}" target="_blank">
                        ...
                        <div class="fr">
                            ...
                            <p class="content-price">
                                <span class="fw-bold c-ff3e3e fs-14"><span class="fs-12">¥</span>${value.sellPrice}</span>
                                <span class="content-border"></span>
                                <span class="td-through">¥${discountPrice}</span>
                            </p>
                            <div class="clear">
                                <span class="fl content-type">${webWay}</span>
                                <a href="${popUrl.website}coupon/transfer?item=${value.itemId}" class="fr content-btn" target="_blank"><span>领${amount}元券</span></a>
                            </div>
                        </div>
                    </li>`;
                    });
