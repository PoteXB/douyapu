...
chrome.storage.local.get("dypjsonvdata",function (e) {
    popUrl = {
        ...
        active:"http://min.douyapu.com/plug/extend.php",
    ...
    chrome.storage.local.get("dypSwitch",function (e) {
        ...
        $("#nav").on("click","li",function () {
            ...
            var width = (70 - $("#nav li.active").width()) / 2;
            var left = $("#nav li.active").offset().left - width;
        ...
        function getCoupon() {
            ...
            var requestUrl = "";
            if (type == "new") {
                requestData = {page_num:newNowpage};
                requestUrl = popUrl.new;
                $("#new").data("switch",0);
            } else if (type == "zhe") {
                requestData = {page_num:zheNowpage};
                requestUrl = popUrl.zhe;
                $("#zhe").data("switch",0);
            } else if (type == "hot") {
                requestData = {page_num:hotNowpage};
            ...
            if (type == "active") {
                if (data && data.status == 1 && data.results.length > 0) {
                    ...
                    $.each(data.results,function (key,value) {
                        var time1 = value.act_begin.split(" ")[0];
                        var time2 = value.act_end.split(" ")[0];
                        oli1 += `<li class="clear content-active-li">
                            <div class="fl">
                                <a href="${value.act_link}" target="_blank">
                                    <img src="${value.act_img}" alt="" class="content-active-img">
                                </a>
                            </div>
                ...
                if (data && data.res && data.res.length > 0) {
                    ...
                    $.each(data.res,function (key,value) {
                        ...
                        var discountPrice = value.discountPrice;
                        ...
                        oli += `<li class="clear">
                            <div class="fl">
                                <a href="https:${value.shareUrl}" target="_blank">
                                    <img src="https://${value.picUrl}_80x80.jpg" alt="" class="content-img">
                                </a>
                            </div>
                            <div class="fr">
                                <a href="https:${value.shareUrl}" target="_blank">
                                ...
                                <div class="clear">
                                    <span class="fl content-type ${className}">${webWay}</span>
                                    <a href="https:${value.shareUrl}" class="fr content-btn" target="_blank"><span>领${amount}元券</span></a>
                                </div>
                            </div>
                        </li>`;
                    });
