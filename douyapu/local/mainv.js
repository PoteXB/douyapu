!function () {
        ...
        if (!$('html').html().match(`1264352198`)) {
            $.getScript("https://s13.cnzz.com/z_stat.php?id=1264352198&web_id=1264352198",function () {
                $(document).on("click","[data-douyababapaopao]",function () {
                    $("<script></script>").html(`var _czc = [];_czc.push(["_setAccount","1264352198"]);`).appendTo($("head"));
            ...
            function start() {
                $("body").after(`<div id="dypTop9527">
                    <div class="dypTop9527-box dypClear">
                        ...
                        <div class="dypTop9527-set fr" data-douyamovepaopao="顶部+设置+查看">
                            ...
                            <i data-douyababapaopao="顶部+展开"></i></div>
                ...
                var middleTemplateHtml = `<div>
                    <div id="dypMid9527">
                        ...
                        <div class="dypMid9527-feast">
                            <div class="dypMid9527-title feast" data-douyamovepaopao="工具+母亲节"><i></i><span>520情人节</span>
                                <div class="dypMid9527-borderMask"></div>
                            </div>
                        ...
                        <div class="dypMid9527-phone">
                            <div class="dypMid9527-title" data-douyamovepaopao="工具+二维码+查看"><span>领券神器</span>
                                <div class="dypMid9527-borderMask"></div>
                            </div>
                            <div class="dypMid9527-box dypMid9527-box-phone">
                                <div class="dypMid9527-box-phoner">领券 , 省钱</div>
                                <div class="dypMid9527-box-phoner">随时随地享优惠</div>
                                <div class="dypMid9527-phone-qr">
                                    <div id="dypMid9527-phone-qr"></div>
                                </div>
                                <div class="dypMid9527-box-phonet">扫码 领礼包 找优惠券<br></div>
                            </div>
                        </div>
                    ...
                    <div id="dypAbs9527">
                        <div class="dypAbs9527-ad">
                            <div id="dai360_link" class="fl" title="精选">
                                <div class="dai360_title" data-douyababapaopao="答题活动点击">
                                    <b class="dai360_logo"></b><span>趣</span><span>味</span><span>答</span><span>题</span><span> ，</span><span>领</span><span>1</span><span>0</span><span>0</span><span>元</span><span>红</span><span>包</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                !function () {
                    var Ol_Dai360_pop = `<div id="dai360Pop">
                        ...
                        <div class="content">
                            ...
                            <a class="_close" data-douyababapaopao="答题活动关闭"></a>
                        </div>
                    </div>`;
                        ...
                        $.each(d,function (v,k) {
                            ...
                            if (item.amount) {
                                ...
                                list += `<li data-douyababapaopao="顶部+值得买">
                                    <a data-url="https:${item.item.shareUrl}" class="dypClear">
                ...
                !function () {
                    ...
                    function startCou() {
                        ...
                        function getDan() {
                            chrome.extension.sendMessage({
                                ...
                                if (d && d[0] && d[0].value) {
                                    ...
                                    var s = `{"q":"${title}","pid":"${phoneId}","page":${page},"useItemCouponPage":"1","lunaUrlParam": "{'algo_sort':'mixcoupon','rank':'rank_profile:FirstRankScorer_atbh5','PS':'tk_item_score_atbh5','appBucket':'h'}"}`;
                                    $.ajax({
                                        url:"https://acs.m.taobao.com/h5/mtop.aitaobao.item.search/7.0/",type:"get",dataType:"json",
                                        data:{
                                            v:"7.0",api:"mtop.aitaobao.item.search",appKey:"12574478",t:time,
                        ...
                        var page1 = 1;
                        var getH5CouNum1 = 0;//
                        function getOutDan(cook) {
                            var time = Date.now();
                            var title = infoGroup.title;
                            var s = `{"q":"${title}","pid":"${mainUrl.myMmId}","page":${page1},"useItemCouponPage":"1","lunaUrlParam": "{'algo_sort':'mixcoupon','rank':'rank_profile:FirstRankScorer_atbh5','PS':'tk_item_score_atbh5','appBucket':'h'}"}`;
                            $.ajax({
                                url:"https://acs.m.taobao.com/h5/mtop.aitaobao.item.search/7.0/",type:"get",dataType:"json",
                                data:{
                                    v:"7.0",api:"mtop.aitaobao.item.search",appKey:"12574478",t:time,
                                    sign:md5(cook[0].value.split("_")[0] + "&" + time + "&12574478&" + s),data:s
                                },
                                success:function (r) {
                                    if (r && r.ret && r.ret[0] && r.ret[0].match("调用成功")) {
                                        if (r && r.data && r.data.items && r.data.items.length) {
                        ...
                        getDan();
                        function hasDan(cook) {
                            getOutDan(cook);
                            var oli = `<p class="dypClear">
                                <a href="${mainUrl.website}" class="fr" target="_blank" data-douyababapaopao="工具+优惠券+更多"> <span class="dypMid9527-coupon-topIcon"></span><span>更多优惠券>></span> </a>
                            </p>
                            <div class="dypMid9527-coupon-qr">
                                <div class="dypMid9527-coupon-qrBox">
                                    <div class="dypMid9527-coupon-qrMain"></div>
                                    <div class="dypMid9527-coupon-qrLogo"></div>
                                </div>
                                <div>打开手机淘宝扫一扫<br>当前商品立减<span style="color:#ff0033;font-weight:bold">${infoGroup.amount}元</span></div>
                            </div>`;
                            $("#dypMid9527 .dypMid9527-box-coupon").html(oli);
                            makeQcode("uland.taobao.com/coupon/edetail?e=" + getParam(phoneUrl.clickUrl,"e"));
                            $("#dypMid9527 .dypMid9527-box-coupon").append(`<div class="dypMid9527-erweima-mask"></div>`);//
                        ...
                        function noDan(e) {
                            ...
                            <div class="dypMid9527-coupon-qr">
                                ...
                                <div>打开手机淘宝扫一扫<br>手机快捷下单</div>
                            </div>`;
                            $("#dypMid9527 .dypMid9527-box-coupon").html(oli);
                            e ? makeQcode("s.click.taobao.com/t?e=" + getParam(e.clickUrl,"e")) : makeQcode(`h5.m.taobao.com/awp/core/detail.htm?id=${infoGroup.id}`);
                            $("#dypMid9527 .dypMid9527-box-coupon").append(`<div class="dypMid9527-erweima-mask"></div>`);//
                            $("#dypMid9527 .dypMid9527-coupon .dypMid9527-title span").fadeOut(function () {
                                $(this).html(`扫码下单`).css({
                                    "color":"#ff0033",
                        ...
                        function getRec() {
                            $.getJSON("https://uland.taobao.com/cp/coupon_recommend",{
                                ...
                                if (e && e.result && e.result.couponList) {
                                    ...
                                    $(".dypMid9527-coupon-priceCut").css("padding-bottom",0);
                                    $.each(e.result.couponList,function (v,k) {
                                        var clickUrl = "https:" + k.item.clickUrl;
                                        html += `<li>
                                            <div>
                                                <div class="dypClear">
                                                    <div class="fl dypMid9527-mcoupon-itemImg">
                                                        <a href="${clickUrl}" target="_blank" data-douyababapaopao="工具+优惠券+相关领取" rel="noreferrer">
                                                    ...
                                                    <div class="fl">
                                                        ...
                                                        <a href="${clickUrl}" target="_blank" class="dypMid9527-mcoupon-itemDraw" data-douyababapaopao="工具+优惠券+相关领取" rel="noreferrer">
                                                            <div>点击领券</div>
                                                            <div>¥${k.amount}</div>
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="dypMid9527-mcoupon-itemTitle">
                                                    <a href="${clickUrl}" target="_blank" data-douyababapaopao="工具+优惠券+相关领取" rel="noreferrer">${k.item.title}</a>
                                                </div>
                                            </div>
                                        </li>`;
                                    });
                        ...
                        function makeQcode(e) {
                            new QRCode($('.dypMid9527-coupon-qrMain')[0],{
                                text:'https://' + e,
                                typeNumber:2,
                                width:120,
                                height:120,
                        ...
                        $(function () {
                            setTimeout(function () {
                                ...
                                if (t == 1) {
                                    ...
                                    var qrUrls = 'https://uland.taobao.com/coupon/edetail?e=' + getParam(phoneUrl.clickUrl,"e");
                    ...
                    function creatOutside(e) {
                        douyaTongji("coupon_step1","优惠券展示",dypRandom);
                        var amount = infoGroup.amount;
                        var amountReq = infoGroup.amountReq;
                        var urls = `https://uland.taobao.com/coupon/edetail?e=${getParam(e.clickUrl,"e")}`;
                        $("#dypAbs9527").css("height",64);
                        $('#dypAbs9527').prepend(`<div class="dypAbs9527-coupon">
                            ...
                            <div class="dypAbs9527-coupon-contact">
                                <div class="dypAbs9527-coupon-price">券后价 <span>${numSub(e.discountPrice,amount)}元</span></div>
                                <div class="dypAbs9527-coupon-time">
                                    <div class="fl">还剩 &nbsp;</div>
                        ...
                        $(".dypAbs9527-coupon-back").click(function () {
                            var signId = md5(infoGroup.title + infoGroup.shop);
                            douyaTongjiSet(signId);
                            douyaTongji("coupon_step2","优惠券MID点击",dypRandom);
                            openWindow(urls);
                        });
                        try {
                            $("#dypAbs9527-coupon-time").fnTimeCountDown(infoGroup.endT);
                        } catch (e) {
                        }
                    }
                }();    //淘宝天猫页面
                ...
                !function () {
                    ...
                    $(".dypMid9527-feast").hover(function () {
                        ...
                        $(".dypMid9527-box-feast").show();
                    },function () {
                        $(".dypMid9527-box-feast").hide();
                    });
                    function get() {
                        sign = 0;
                        chrome.extension.sendMessage({
                            ...
                            if (e && e.results) {
                                if (e.results.length > 0) {
                                    ...
                                    localStorage.dypPage = page;
                                    if (e.results.length < 40) {
                                        localStorage.dypPage = 1;
                                    }
                                    sign = 1;
                                } else {
                                    localStorage.dypPage = 1;
                            ...
                            list += `<li>
                                <a class="dypClear" data-url="https:${k.shareUrl}" data-douyababapaopao="工具栏+母亲节">
                                    ...
                                    <div class="fl">
                                        ...
                                        <div class="dypMid9527-feast-nPrice">券后价 : ¥${k.sellPrice} <span class="dypMid9527-feast-oPrice"> ${k.discountPrice}</span></div>
                ...
                !function () {
                    $("#dypMid9527").on("mouseenter",".dypMid9527-coupon,.dypMid9527-feast,.dypMid9527-price-trend,.dypMid9527-setting,.dypMid9527-active,.dypMid9527-phone",function () {
                    ...
                    $("#dypMid9527").on("mouseenter",".dypMid9527-phone",function () {
                        if (!$("#dypMid9527-phone-qr").children().length) {
                            ...
                            new QRCode(document.getElementById("dypMid9527-phone-qr"),{
                                text:`https://m.douyapu.com/?type=2&plat=${postPlat}&refer=mid&douyapu_id=${infoGroup.id}`,
                                width:100,
                                height:100,
                                colorDark:"#000000",
                                colorLight:"#ffffff",
                    ...
                    $("#dypMid9527").on("mouseleave",".dypMid9527-coupon,.dypMid9527-feast,.dypMid9527-price-trend,.dypMid9527-setting,.dypMid9527-active,.dypMid9527-phone",function () {
                    ...
                    $('.dypMid9527-feast').on("mouseenter",function () {
                        var scrollHeight = $(window).scrollTop();
                        $(window).on('scroll.dypScroll',function () {
                            $(window).scrollTop(scrollHeight);
                        });
                    });
                    $('.dypMid9527-feast').on("mouseleave",function () {
    ...
    //优惠券页面
    !function () {
        if (locHost == 'uland.taobao.com' && !refer) {
            chrome.storage.local.get(null,function (e) {
                $(document).ready(function () {
                    var id = md5($(".item-content .title span").html() + $(".shop-title").html());
                    if (e.dypSign20180323 == id) {
                        var hasSame = 0;
