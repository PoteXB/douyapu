            ...
            function start() {
                ...
                var middleTemplateHtml2 = `
                        ...
                        <div class="dypMid9527-feast">
                            <div class="dypMid9527-title feast" data-douyamovepaopao="工具+母亲节"><i></i><span>情人节</span>
                                <div class="dypMid9527-borderMask"></div>
                            </div>
                            ...
                            if (item.amount) {
                                ...
                                list += `<li data-douyababapaopao="顶部+值得买">
                                    <a data-url="https:${item.shareUrl}" class="dypClear">
                                        <div class="fl"><img src="${item.picUrl}_140x140.jpg" alt=""></div>
                ...
                !function () {
                    $("#dypMid9527").on("mouseenter",".dypMid9527-coupon,.dypMid9527-feast,.dypMid9527-price-trend,.dypMid9527-setting,.dypMid9527-active,.dypMid9527-phone,.dypMid9527-same",function () {
                    ...
                    $("#dypMid9527").on("mouseleave",".dypMid9527-coupon,.dypMid9527-feast,.dypMid9527-price-trend,.dypMid9527-setting,.dypMid9527-active,.dypMid9527-phone,.dypMid9527-same",function () {
