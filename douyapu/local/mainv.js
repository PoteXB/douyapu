!function () {
    if ($("body").attr("firstSign2018827") == 1) {
        return
    }
    ...
    function cnzzAppend(callBack) {
        if (!$('html').html().match(`1274446328`)) {
            ...
            $.getScript("https://s22.cnzz.com/z_stat.php?id=1274446328&web_id=1274446328",function () {
                var myScript = document.createElement("script");
                myScript.appendChild(document.createTextNode(`var douyapu_czc = _czc;_czc = [];`));
                document.head.appendChild(myScript);
            ...
            function start() {
                ...
                var middleTemplateHtml2 = `
                    ...
                    <div class="dypMid9527-feast" data-douyaYR="栏目三">
                        <div class="dypMid9527-title feast"><i></i><span>中秋好礼</span>
                            <div class="dypMid9527-borderMask"></div>
                        </div>
                ...
                var htmlPublic = {
                    hasCouHtml:function (price,amount,amountReq,pingtai) {
                        return `<div class="dypAbs9527-coupon">
                            ...
                            <div class="dypAbs9527-coupon-contact">
                                <div class="dypAbs9527-coupon-price">券后价 <span>${numSub(price,amount)}元</span><a href="${qqOnline}" target="_blank"><b></b></a></div>
                            ...
                            <div class="dypAbs9527-coupon-qr">
                                ...
                                <div class="dypAbs9527-coupon-qrBox">
                                    ...
                                    <div class="dypAbs9527-coupon-qrTitle">${pingtai}扫码领券<br>商品<span></span></div>
                                </div>
                            </div>
                        </div>`
                    },
                    noCouHtml:function (pingtai) {
                        return `<div class="dypAbs9527-coupon">
                            ...
                            <div class="dypAbs9527-coupon-contact-no">
                                ...
                                <div>用手机${pingtai}扫描右侧二维码 , 3秒快捷下单~</div>
                            </div>
                            ...
                            <div class="dypAbs9527-coupon-qr">
                                ...
                                <div class="dypAbs9527-coupon-qrBox">
                                    <div class="dypAbs9527-coupon-qrImg"></div>
                                    <div class="dypAbs9527-coupon-qrTitle">打开手机${pingtai}<br>扫码轻松下单</div>
                                </div>
                            </div>
                        </div>`
                    },
                    makeQcode:function (e) {
                        ...
                        $('.dypAbs9527-coupon-qrImg').attr("title","");
                    }
                };
                !function () {
                    if (infoGroup.plat != 'tm' && infoGroup.plat != 'tb' && infoGroup.plat != 'ju') {
                    ...
                    function startCou() {
                        ...
                        function getDanNewApi(typeName) {
                            chrome.extension.sendMessage({
                                ...
                                if (data.success && data.list && data.list.item && data.list.item.couponInfo && data.list.item.endTime && data.list.item.totalCount) {
                                    ...
                                    $('#dypAbs9527').prepend(htmlPublic.noCouHtml('淘宝'));
                                    getQrDan();
                                }
                            });
                        } //新API请求优惠券数据
                        ...
                        function hasDan(k) {
                            ...
                            $('#dypAbs9527').prepend(htmlPublic.hasCouHtml(k.discountPrice,amount,amountReq,'手淘'));  //  淘宝有券
                            $(".dypAbs9527-coupon-back").click(function () {
                                openWindow(urls);
                            });
                            try {
                        ...
                        function makeScan(k,type) {
                            if (type == "no") {
                                k ? htmlPublic.makeQcode("https://s.click.taobao.com/t?e=" + getParam(k.clickUrl,"e")) : htmlPublic.makeQcode(`https://h5.m.taobao.com/awp/core/detail.htm?id=${infoGroup.id}`);
                            } else if (type == "has") {
                                $('.dypAbs9527-coupon-qrTitle span').html(`立减${infoGroup.amount}元`);
                                htmlPublic.makeQcode("https://uland.taobao.com/coupon/edetail?e=" + getParam(k.clickUrl,"e"));
                            }
                        }   //生成外部扫一扫二维码
                    }//
                    function startPostCou() {
                        ...
                        function saveCoupon(k,type) {
                            if (k && type == 'has') {
                                ...
                                var plant = (infoGroup.plat == "tm") ? 2 : 1;
                                action = 'cp_effec';
                                postData = {
                                    itemId:infoGroup.id,
                ...
                !function () {
                    ...
                    myScript.appendChild(document.createTextNode('window.postMessage({"douyaData":{id:pageConfig.product.skuid,cat:pageConfig.product.cat,venderId:pageConfig.product.venderId,shopId:pageConfig.product.shopId}},"*")'));
                    document.body.appendChild(myScript);
                    window.addEventListener("message",function (event) {
                        if (event.data.douyaData) {
                            itemId = event.data.douyaData.id;
                            info.venderId = event.data.douyaData.venderId;
                            info.cat = event.data.douyaData.cat.toString();
                            jdCat = info.cat;
                            info.shopId = event.data.douyaData.shopId;
                            $.ajax({
                    ...
                    startVip();
                    function getJdBuyShow() {
                        var requestUrl = 'https://sclub.jd.com/comment/productPageComments.action?score=0&sortType=5&pageSize=10&isShadowSku=0&fold=1&productId=' + itemId + '&page=';
                        var totalNum;
                        var showKaiguan = 1;
                        $.ajax({
                            type:"get",
                    ...
                    function startCou() {
                        function getDanNewApi() {
                            chrome.extension.sendMessage({
                                name:"universal",url:"http://report.douyapu.com/jd",type:"post",dataType:"json",data:{
                                    skuId:itemId,type:"y",action:'coupon'
                                }
                            },function (e) {
                                if (e && e.code == 1) {
                                    setCoupon(e.msg,'has')
                        ...
                        function setCoupon(k,type) {
                            if (k && type == 'has') {
                                $('#dypAbs9527').prepend(htmlPublic.hasCouHtml(k.pcPrice,k.discount,`满${k.quota}减${k.discount}`,'微信')); //京东有券渲染
                                $(".dypAbs9527-coupon-back").append(hasCouponAdd());
                                startScan(k.link);
                                $("#dypAbs9527-coupon-time").fnTimeCountDown(k.endTime,1);
                                $(".dypAbs9527-coupon-time").css("visibility","visible");
                                htmlPublic.makeQcode(k.link);
                                $('.dypAbs9527-coupon-qrTitle span').html(`立减${k.discount}元`);
                            } else {
                                getDanSelf();
                            }
                        }                    //
                                    ...
                                    chrome.extension.sendMessage({
                                        ...
                                        if (d && d.code == 1 && d.msg) {
                                            chrome.extension.sendMessage({
                                                ...
                                                $('#dypAbs9527').prepend(htmlPublic.hasCouHtml(price,data.discount,`满${data.quota}减${data.discount}`,'微信')); //京东有券渲染
                                                $(".dypAbs9527-coupon-back").append(hasCouponAdd());
                                                startScan(d.msg);
                                                $("#dypAbs9527-coupon-time").fnTimeCountDown(data.endTime + ' 23:59:59');
                                                $(".dypAbs9527-coupon-time").css("visibility","visible");
                                                htmlPublic.makeQcode(d.msg);
                                                $('.dypAbs9527-coupon-qrTitle span').html(`立减${data.discount}元`);
                                            });
                                        } else {
                                            noCoupon();
                                        }
                        ...
                        function getQrNoDan() {
                            chrome.extension.sendMessage({
                                ...
                                if (e && e.code == 1) {
                                    htmlPublic.makeQcode(e.msg);
                                }
                            });
                        }                         //获取无券转链二维码
                        function noCoupon() {
                            $('#dypAbs9527').prepend(htmlPublic.noCouHtml('微信'));
                            getQrNoDan()
                        }                           //无券时的处理
                        function hasCouponAdd() {
                            return `<div class="dypAbs9527-couScan"><div id="dypAbs9527-couScan"></div><div class="dypAbs9527-couScan-title">扫码立即领券</div></div>`
                        }                       //有券时追加二维码dom
                        function startScan(qrcodeText) {
                            //生成二维码
                            new QRCode($("#dypAbs9527-couScan")[0],{
                                text:qrcodeText,
                                width:100,
                                height:100,
                                colorDark:"#000000",
                            ...
                            $("#dypAbs9527-couScan").attr("title","");
                            $(".dypAbs9527-coupon-back").removeAttr('data-douyaDJ');
                            $(".dypAbs9527-coupon-back").attr('data-douyaYR','京东领取优惠券');
                            $(".dypAbs9527-coupon-back").hover(
                                function () {
                                    $(".dypAbs9527-couScan").show();
                                },
                                function () {
                                    $(".dypAbs9527-couScan").hide();
                                });
                        }                //生成二维码
                        getDanNewApi();
                    }
                ...
                !function () {
                    ...
                    var swi = 1;
                    var times = '';
                    var reqUrl = `${mainUrl.min}&v=中秋OR月饼&page_size=25&page_num=`;
                ...
                $.extend($.fn,{
                    fnTimeCountDown:function (d,chuo) {
                        this.each(function () {
                            var $this = $(this);
                            var o = {
                                hm:$this.find(".hm"),
