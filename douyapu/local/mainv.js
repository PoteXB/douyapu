    ...
    !function () {
        ...
        if (adaptationOk) {
            ...
            function start() {
                ...
                var middleTemplateHtml = `<div><div id="dypMid9527"><div class="dypMid9527-logo" data-douyababapaopao="工具+logo"><a href="${mainUrl.website}" target="_blank"></a></div><div class="dypMid9527-coupon"><div class="dypMid9527-title" data-douyamovepaopao="工具+优惠券+查看"><span>优惠折扣</span><div class="dypMid9527-borderMask"></div></div><div class="dypMid9527-box dypMid9527-box-coupon"><div class="dypMid9527-coupon-loading"><b></b><span>正在全力加载中</span></div></div></div><div class="dypMid9527-active"><div class="dypMid9527-title" data-douyamovepaopao="工具+活动+查看"><span>限时活动</span><div class="dypMid9527-borderMask"></div></div><div class="dypMid9527-box dypMid9527-box-active"><ul></ul><div><button class="l"></button><button class="r"></button></div></div></div><div class="dypMid9527-price-trend"><div class="dypMid9527-title dypMid9527-price-title" data-douyamovepaopao="工具+价格+查看"><span>价格平稳</span><b></b><div class="dypMid9527-borderMask"></div></div><div class="dypMid9527-box dypMid9527-box-price yhq-chart-box"><div id="douyapu-line-chart"></div><div class="dypMid9527-priceBox-title">注意：价格趋势由<span>豆芽网</span>提供，数据仅供参考</div><div class="dypMid9527-priceBox-back"><span>抱歉，该商品的价格趋势正在收录中</span></div><div class="dypMid9527-AllShop-price"><div class="dypMid9527-AllShop-box"><div class="dypMid9527-AllShop-title"><span class="dypMid9527-World-icon"></span><span class="dypMid9527-World-title">全网比价</span></div><div class="dypMid9527-AllShop-content"></div></div></div></div></div><div class="dypMid9527-must-see"><div class="dypMid9527-title" data-douyababapaopao="工具+必看评价"><span>必看评价</span></div></div><div class="dypMid9527-buyers-show"><div class="dypMid9527-title" data-douyababapaopao="工具+买家秀"><span>买家秀</span></div></div><div class="dypMid9527-phone"><div class="dypMid9527-title" data-douyamovepaopao="工具+二维码+查看"><span>领券神器</span><div class="dypMid9527-borderMask"></div></div><div class="dypMid9527-box dypMid9527-box-phone"><div class="dypMid9527-box-phoner">领券 , 省钱</div><div class="dypMid9527-box-phoner">随时随地享优惠</div><div class="dypMid9527-phone-qr"><div id="dypMid9527-phone-qr"></div></div><div class="dypMid9527-box-phonet">扫码下载<br>省钱APP-豆芽铺</div></div></div><div class="dypMid9527-setting"><div class="dypMid9527-title dypMid9527-setting-title" data-douyamovepaopao="工具+设置+查看"><b></b><div class="dypMid9527-borderMask"></div></div><div class="dypMid9527-box dypMid9527-box-setting"><ul><li data-type="2" data-douyababapaopao="工具+设置+意见反馈">意见反馈</li><li data-type="1" data-douyababapaopao="工具+设置+本次关闭">本次关闭</li></ul></div></div></div><div id="dypAbs9527"><div class="dypAbs9527-ad"><div id="dai360_link" class="fl" title="精选"><div class="dai360_title" data-douyababapaopao="答题活动点击"><b class="dai360_logo"></b><span>趣</span><span>味</span><span>答</span><span>题</span><span> ,</span><span>领</span><span>1</span><span>0</span><span>0</span><span>元</span><span>红</span><span>包</span></div></div><div class="dypAbs9527-font_inner1-box fl"><ul class="dypAbs9527-font_inner1"></ul></div></div></div></div>`;
                ...
                !function () {
                        ...
                        $(function () {
                            setTimeout(function () {
                                ...
                                if (t == 1) {
                                    ...
                                    $("#dypBot9527").append(`<div class="dypBot9527-coupon">
                                        <a data-douyababapaopao="底部-优惠券">领券<span> ${e.couponAmount / 100}元</span></a>
                    ...
                    function creatOutside(e) {
                        ...
                        $('#dypAbs9527').append(`<div class="dypAbs9527-coupon">
                        ...
                        chrome.extension.sendMessage({name:"universal",url:url2,type:"get",dataType:"json"},function (response) {
                            if (response && response.results && response.results.length > 0) {
                                !function () {
                                    ...
                                    $(".dypAbs9527-font_inner1").append(html);
                                    $(".dypAbs9527-font_inner1 li:eq(0)").clone(true).appendTo($(".dypAbs9527-font_inner1"));
                                    var liHeight = $(".dypAbs9527-ad").height();
                                    var totalHeight = ($(".dypAbs9527-font_inner1 li").length * $(".dypAbs9527-font_inner1 li").eq(0).height()) - liHeight;
                                    $(".dypAbs9527-font_inner1").height(totalHeight);
                                    var index = 0;
                                    var autoTimer = 0;
                                    var clickEndFlag = true;    //
                                    function tab() {
                                        $(".dypAbs9527-font_inner1").stop().animate({
                                            top:-index * liHeight
                                        },400,function () {
                                            clickEndFlag = true;
                                            if (index == $(".dypAbs9527-font_inner1 li").length - 1) {
                                                $(".dypAbs9527-font_inner1").css({top:0});
                                                index = 0;
                                            }
                                        })
                                    }   //
                                    ...
                                    autoTimer = setInterval(next,2500);
                                    $(".dypAbs9527-font_inner1 a").hover(function () {
                                        clearInterval(autoTimer);
                                    },function () {
                                        autoTimer = setInterval(next,2500);
                                    });
