...
$("body").append('<iframe src=' + loginApiUrl.loginTypeUrl + '/statistics/plugs/?type=setting id="douya-yangxue9527" style="display:none"></iframe>');
$("body").on("click", "[data-douyababapaopao]", function () {
    $("#douya-yangxue9527").attr("src", loginApiUrl.loginTypeUrl + "/statistics/plugs/?type=setting&name=" + $(this).attr("data-douyababapaopao"));
});