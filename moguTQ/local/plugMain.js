setTimeout(function () {
    ...
    function start() {
        ...
        !function () {
            ...
            function noCouponQrHtml(t) {
                return `<div class="plugMid627-couEmpty"></div>
                <div class="plugMid627-couQr" data-moguYR="扫码下单">
            ...
            function hasCouHtml(a,b,c,p) {
                return `<div class="plugMid627-couBox">
                    ...
                    <div class="plugMid627-couQr" data-moguYR="扫码领券">
                        <div class="plugMid627-couQr-icon"></div>
                ...
                function startCou() {
                    ...
                    function getDanNewApi() {
                        chrome.extension.sendMessage({
                            ...
                            if (data.success && data.list && data.list.item && data.list.item.couponInfo && data.list.item.endTime && data.list.item.totalCount) {
                                ...
                                var html = hasCouHtml(data.finalPrice,amount,amountReq,'手淘');   //淘宝平台新接口渲染
                    ...
                    function setCoupon(k,type) {
                        if (k && type == 'has') {
                            ...
                            var html = hasCouHtml(k.discountPrice,k.couponAmount / 100,"",'手淘');    //淘宝平台旧接口渲染
                            $(".plugMid627-hasCoupon").html(html);
                            $(".plugMid627-hasCoupon").show();
                            $(".plugMid627-couBack").click(function () {
                                openWindow(openUrl);
            ...
            !function () {
                ...
                function startCou() {
                    ...
                    function setCoupon(k,type) {
                        if (k && type == 'has') {
                            $(".plugMid627-hasCoupon").html(hasCouHtml(k.pcPrice,k.discount,`满${k.quota}减${k.discount}`,'微信')); //京东平台有券渲染
                                ...
                                chrome.extension.sendMessage({
                                    ...
                                    if (d && d.code == 1 && d.msg) {
                                        chrome.extension.sendMessage({
                                            ...
                                            $(".plugMid627-hasCoupon").html(hasCouHtml(price,data.discount,`满${data.quota}减${data.discount}`,'微信'));//京东平台有自己店铺券渲染
                                            $(".plugMid627-couBack").append(hasCouponAdd());
                                            startScan(d.msg);
                                            $(".plugMid627-hasCoupon").show();
                    ...
                    function getQrNoDan() {
                        chrome.extension.sendMessage({
                            name:"universal",
                            url:"http://report.douyapu.com/jd",
                            // url:"http://192.168.3.229:9988/private",
                            type:"post",
                            dataType:"json",
                            data:{
                                itemid:itemId,
                            ...
                            if (e && e.code == 1) {
                                $(".plugMid627-couBox").append(noCouponQrHtml("微信"));
        ...
        !function () {
            //             var htmlVal = `<div id="plugBot627">
            //     <div class="plugBot627-logo"></div>
            //     <div class="plugBot627-burst">
            //         <div class="plugBot627-burst-head"></div>
            //         <div class="plugBot627-burst-drop">
            //             <div>
            //                 <div class="plugBot627-burst-dropHead">今日好物</div>
            //                 <ul>
            //                     <li>
            //                         <img src="http://oimageb6.ydstatic.com/image?id=-7608276205175680505&amp;product=gouwu">
            //                         <div>
            //                             <p class="plugBot627-burst-dropTitle">Han Dynasty 汉 HD59312 男...</p>
            //                             <p class="plugBot627-burst-dropPrice">19元包邮</p>
            //                         </div>
            //                     </li>
            //                     <li>
            //                         <img src="http://oimageb6.ydstatic.com/image?id=-7608276205175680505&amp;product=gouwu">
            ...
            //         </div>
            //     </div>
            //     <div class="plugBot627-coupon">
            //         <div class="plugBot627-coupon-head"></div>
            //     </div>
            //     <div class="plugBot627-rollAd">
            //         <ul>
            //             <li><img src="http://oimageb3.ydstatic.com/image?id=-4779587469870477698&product=gouwu"></li>
            //         </ul>
            //     </div>
            // </div>`;
            //             chrome.extension.sendMessage({
