...
setTimeout(function () {
    ...
    function cnzzAppend(callBack) {
        if (!$('html').html().match(`1274446353`)) {
            ...
            myScript.appendChild(document.createTextNode(`var back_czc = _czc?_czc:[];var _czc = [];_czc.push(["_setAccount","1274446353"]);`));
            document.head.appendChild(myScript);
            $.getScript("https://s22.cnzz.com/z_stat.php?id=1274446353&web_id=1274446353",function () {
                var myScript = document.createElement("script");
                myScript.appendChild(document.createTextNode(`var mogu_czc = _czc;_czc = back_czc;`));
                document.head.appendChild(myScript);
    ...
    function start() {
        ...
        !function () {
            var data = [
                {name:'618活动',title:'季末大放送 , 爆款低价',pic:'http://file.douyapu.com/douyapu/dai360/2018618.png',clickE:"滚动广告1",type:0,url:"https://s.click.taobao.com/ySoCNOw"}
            ];
            var html = '';
            $.each(data,function (v,k) {
